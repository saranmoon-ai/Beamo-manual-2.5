const UI = {
  ko: {
    langName: "한국어",
    siteName: "Beamo 매뉴얼",
    portalBtn: "Beamo Portal 연결",
    heroLabel: "BEAMO OFFICIAL MANUAL",
    heroTitle: "Beamo 통합 매뉴얼 센터",
    heroSubtitle: "버전, 환경, 기능, 사용자 유형, 단계별로 원하는 가이드를 빠르게 찾아보세요.",
    heroSearchPlaceholder: "검색어를 입력하세요",
    searchBtn: "검색",
    quickManualTitle: "빠른 매뉴얼",
    quickManualSurveyorSub: "촬영자용 (App)",
    quickManualAdminSub: "관리자용 (Web)",
    manualVideoTitle: "매뉴얼 영상",
    manualVideoSub: "영상 가이드 (준비중)",
    browseByEng: "BROWSE BY",
    browseByTitle: "원하는 기준으로 찾아보기",
    browseByDesc: "다섯 가지 기준 중 하나를 선택해 세부 항목을 좁혀나갈 수 있습니다.",
    home: "홈",
    resultsTitle: "가이드 목록",
    backToList: "목록으로 돌아가기",
    noResults: "해당 조건에 맞는 문서가 없습니다.",
  ...
  en: {
    langName: "English",
    siteName: "Beamo Manual",
    portalBtn: "Connect to Beamo Portal",
    heroLabel: "BEAMO OFFICIAL MANUAL",
    heroTitle: "Beamo Manual Center",
    heroSubtitle: "Find the right guide by version, platform, feature, user type, or step.",
    heroSearchPlaceholder: "Enter a search term",
    searchBtn: "Search",
    quickManualTitle: "Quick Start",
    quickManualSurveyorSub: "For Surveyors (App)",
    quickManualAdminSub: "For Admins (Web)",
    manualVideoTitle: "Manual Video",
    manualVideoSub: "Video Guide (Coming Soon)",
    browseByEng: "BROWSE BY",
    browseByTitle: "Browse by category",
    browseByDesc: "Pick one of the five axes below to narrow down the guides you need.",
    home: "Home",
    resultsTitle: "Guides",
    backToList: "Back to list",
    noResults: "No articles match this selection.",
  ...
  ja: {
    langName: "日本語",
    siteName: "Beamo マニュアル",
    portalBtn: "Beamo Portal に接続",
    heroLabel: "BEAMO OFFICIAL MANUAL",
    heroTitle: "Beamo マニュアルセンター",
    heroSubtitle: "バージョン・環境・機能・ユーザータイプ・ステップから必要なガイドを見つけましょう。",
    heroSearchPlaceholder: "検索キーワードを入力してください",
    searchBtn: "検索",
    quickManualTitle: "クイックマニュアル",
    quickManualSurveyorSub: "サーベイヤー向け (App)",
    quickManualAdminSub: "管理者向け (Web)",
    manualVideoTitle: "マニュアル動画",
    manualVideoSub: "動画ガイド（準備中）",
    browseByEng: "BROWSE BY",
...
const V2_SUPPORT_URL = {
  ko: "https://support.beamo.ai/hc/ko",
...
const SOCIAL_LINKS = [
  { name: "LinkedIn", url: "https://www.linkedin.com/company/beamo-digital-twin/" },
  { name: "YouTube", url: "https://www.youtube.com/channel/UCP99psnO3x9C0QxIpHD9FIw" },
  { name: "Instagram", url: "https://www.instagram.com/beamo.ai/" },
  { name: "Facebook", url: "https://www.facebook.com/beamo.digital.twin" },
  { name: "X", url: "https://x.com/Beamo_ai" }
];
